...
$selectAll = queryData("SELECT * FROM media WHERE status = 'Take' ORDER BY id desc");
      ...
      <section id="input media" class="container vh-100 ">
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h1 class="modal-title fs-5" id="exampleModalLabel">PLANNER Social Media</h1>
                      ...
                      <div class="mb-3">
                        ...
                        <div class="input-group">
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="type" id="socmed" value="socmed">
                            <label class="form-check-label" for="socmed">Socmed</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="type" id="promo" value="promo">
        ...
        <button type="button" class="btn btn-sm btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
            Input Media
        </button>
            ...
            <?php
              ...
              <div class="modal fade" id="modal_lihat_<?=$data['id']?>" tabindex="-1" aria-labelledby="modal_lihat_<?=$data['id']?>Label" aria-hidden="true">
                ...
                <td>
                  ...
                  <button name="btn_upload" type="submit" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modal_upload_<?=$data['id']?>">Upload</button>
                  <div class="modal fade" id="modal_upload_<?=$data['id']?>" tabindex="-1" aria-labelledby="modal_upload_<?=$data['id']?>Label" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h1 class="modal-title fs-5" id="modal_upload_<?=$data['id']?>Label">Pindah Konten <?=$data['id']?></h1>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                          Konten akan dipindahkan ke Upload
                          <form action="" method="post">
                            <input type="hidden" name="id" value="<?=$data['id']?>">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button name="btn_upload" type="submit" class="btn btn-success">Save changes</button>
                          </form>
                        </div>
                      </div>
                    </div>
